...
You can find the .tlv file and the final diagram of the RISC-V core in the repository.  
The project was coded on the [MakerChip IDE by Redwood EDA, LLC](https://www.makerchip.com)

## Project Structure
| Folder/File | Description |
|---|---|
| `RISC-V-CPU-Core-main/` | TL-Verilog CPU core implementation |
| `RV32IM-Core-master/` | Pipeline implementation |
| `Final Project Presenteation.pptx` | Project presentation |
| `Project_book.docx` | Project documentation |
| `Summary RISC-V instruction set.docx` | RISC-V instruction set summary |
| `alu_table.xlsx` | ALU operations table |
...
As the course progressed I learned about the RV32I and the different parts of the RISC-V core.  
For any questions you can contact me at: maorelbaz90@gmail.com
...
## Source Code
The CPU core is implemented in TL-Verilog, inside the `RISC-V-CPU-Core-main/` folder.  
It can be opened and simulated directly in the [MakerChip IDE](https://makerchip.com).
