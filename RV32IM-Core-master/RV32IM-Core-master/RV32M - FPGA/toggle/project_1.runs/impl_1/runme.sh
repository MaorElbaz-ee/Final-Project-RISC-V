...
HD_PWD='C:/Users/salti/Desktop/Final_Project/RV32M - FPGA/toggle/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flip_seg.tcl -notrace
