...
HD_PWD='C:/Users/salti/Desktop/Final_Project/RV32M - FPGA/toggle/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flip_seg.tcl
